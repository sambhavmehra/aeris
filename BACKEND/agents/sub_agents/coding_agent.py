"""
AERIS — Coding Agent (Sub-Agent) [ADVANCED]
====================================================
...
_BASE_SYSTEM = """\
You are AERIS's Coding Agent — a specialised AI programmer embedded in a
...
class CodingAgent(BaseAgent):
    ...
    def __init__(self, memory_agent=None, enable_cache: bool = True,
        ...
        super().__init__(name="CodingAgent", memory_agent=memory_agent)
