...
def _safe_template(bucket: str, mode: str, hacker_mode: bool = False) -> str:
    if hacker_mode:
        templates = {
            "morning": {
                "coding": "Sir, morning zero-day patch cycle. Deploy.",
                "research": "Sir, morning threat intel sweep initiated.",
                "security": "Sir, morning perimeter scan. Targets locked.",
                "designing": "Sir, morning kill chain mapping active.",
                "chat": "Sir, morning OPSEC verified. Awaiting directive.",
            },
            "afternoon": {
                "coding": "Sir, afternoon exploit module development.",
                "research": "Sir, afternoon darknet intelligence parsing.",
                "security": "Sir, afternoon attack surface audit.",
                "designing": "Sir, afternoon network topology analysis.",
                "chat": "Sir, afternoon recon protocols standing by.",
            },
            "evening": {
                "coding": "Sir, evening binary analysis. Reversing targets.",
                "research": "Sir, evening SIGINT collection active.",
                "security": "Sir, evening threat hunting initiated.",
                "designing": "Sir, evening adversary modeling phase.",
                "chat": "Sir, evening shadow operations. Status green.",
            },
            "night": {
                "coding": "Sir, night payload engineering. Silent deploy.",
                "research": "Sir, night deep web reconnaissance.",
                "security": "Sir, night phantom sweep. Zero detection.",
                "designing": "Sir, night cyber kill chain finalized.",
                "chat": "Sir, night watch. All vectors monitored.",
            },
        }
